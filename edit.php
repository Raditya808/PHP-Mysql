...
$dataMahasiswa = query("SELECT * FROM mhs WHERE nim = '$nim'")[0]; // Pastikan query mengembalikan satu data
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE mhs SET nim = '$nim', nama = '$nama', prodi = '$prodi', jk = '$jk', alamat = '$alamat' WHERE nim = '$nim'";
